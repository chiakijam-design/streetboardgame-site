  ...
  async fetch(request, env) {
    ...
    const pageMap = {
      '/love': {
        ...
        description: 'メインは彼氏が彼女の答えを当てる彼氏の愛情判定ゲーム。彼女版は同じゲーム内で切り替えでき、大学生カップルのデート、飲み会、旅行、おうち時間にスマホ1台で遊べます。',
      ...
      '/friends': {
        ...
        description: '友達同士で本人の答えを予想する無料友情診断ゲーム。大学生の集まり、休み時間、飲み会、旅行で2〜4人プレイに対応し、友達の理解度を楽しくチェックできます。',
      ...
      '/family': {
        ...
        description: '家族で本人の答えを予想する無料の絆チェックゲーム。親子、兄弟姉妹、親戚の集まり、家族旅行で2〜4人プレイに対応し、家族の理解度を楽しく確認できます。',
