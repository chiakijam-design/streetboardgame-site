  ...
  async fetch(request, env) {
    ...
    const pageMap = {
      ...
      '/live-guide': {
        ...
        description: 'YouTuberと視聴者が一問ずつ同時回答し、全問終了後に一問ずつ答え合わせする無料ライブ投票ゲームです。',
        ...
        noscriptBody: 'YouTubeチャンネルからスタッフが問題企画を保存し、配信中にYouTuberと視聴者が同時回答した後、一問ずつ答え合わせする無料ライブゲームです。',
        faq: [
          {
          ...
          },
          {
            ...
            answer: '企画作成時には入力しません。配信中に視聴者と同じ問題へ同時に回答し、「次の問題へ」を押した時点で両方の回答を締め切ります。',
          },
          {
