...
async function withSecurityHeaders(response, request) {
  ...
  headers.set('content-security-policy', [
    ...
    "img-src 'self' data: blob: https://c.clarity.ms",
    "connect-src 'self' blob: https://www.google-analytics.com https://region1.google-analytics.com https://h.clarity.ms https://formspree.io",
