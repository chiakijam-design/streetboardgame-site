...
async function withSecurityHeaders(response, request) {
  ...
  headers.set('content-security-policy', [
    ...
    `script-src 'self'${nonce ? ` 'nonce-${nonce}' 'strict-dynamic'` : ''} https://www.googletagmanager.com https://www.clarity.ms https://scripts.clarity.ms`,
    "script-src-attr 'none'",
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
    "font-src 'self' data: https://fonts.gstatic.com",
    "img-src 'self' data: blob: https://*.google-analytics.com https://www.googletagmanager.com https://c.clarity.ms",
    "connect-src 'self' blob: https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com https://h.clarity.ms https://formspree.io",
