  ...
  return `
    ...
    <section class="challenge-panel">
      ...
      <section class="challenge-role-swap" data-testid="challenge-role-swap">
        <span class="challenge-section-label">おすすめ</span>
        <h2>次は、あなたが出題者</h2>
      ...
      <a class="challenge-secondary" href="/challenge">新しいお題で作る</a>
...
async function createChallengeResultCanvas(result) {
  ...
  context.font = '700 19px "Noto Sans JP", sans-serif';
  ...
  context.font = '900 21px "Noto Sans JP", sans-serif';
  ...
  context.fillStyle = '#ec4683';
  context.font = '700 31px "Noto Sans JP", sans-serif';
  context.textAlign = 'left';
  ...
  context.font = '900 116px "Noto Sans JP", sans-serif';
  ...
  context.font = `900 ${titleLines.length > 1 ? 46 : 54}px "Noto Sans JP", sans-serif`;
  ...
  context.stroke();
  context.fillStyle = '#191919';
  context.font = '900 31px "Noto Sans JP", sans-serif';
  ...
  context.stroke();
  context.fillStyle = '#191919';
  context.font = '900 28px "Noto Sans JP", sans-serif';
  ...
  context.fillStyle = '#191919';
  context.font = '700 22px "Noto Sans JP", sans-serif';
