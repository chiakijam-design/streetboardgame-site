(function languageSwitch() {
  ...
  function addStyles() {
    ...
    style.textContent = `
      .site-language-switch{position:fixed;z-index:2147483000;top:max(8px,env(safe-area-inset-top));right:8px;display:flex;align-items:center;min-height:44px;padding:4px;background:rgba(255,255,255,.96);border:2px solid #191919;border-radius:999px;box-shadow:2px 3px 0 #191919;font:800 13px/1.2 Arial,"Yu Gothic",sans-serif;color:#191919}
      ...
      html[data-challenge-mode$="-answer"] .site-language-switch,html[data-live-challenge-phase="voting"] .site-language-switch,html[data-live-challenge-phase="reveal"] .site-language-switch{top:auto;right:6px;bottom:max(6px,env(safe-area-inset-bottom));opacity:.82}
