...
function TopScreen({ onStart, onFriend, onFamily, onLovePage, onFriendPage, onFamilyPage, onAbout, onProduct }) {
  return (
    <main aria-labelledby="site-title" style={{
      ...
      <p style={srOnlyStyle()}>
        彼氏が彼女の答えをどれだけ当てられるかを判定する無料カップル診断ゲームです。スマホ1台でデート、飲み会、旅行、おうち時間に遊べます。彼氏の愛情判定をメインに、同じゲーム内で遊べる彼女版、友達の友情判定、家族の絆判定も公開中です。
      </p>
    ...
    faq: [
      {
        ...
        a: 'どちらの答えを相手が当てるかを選べます。彼女の答えを彼氏が当てる遊び方も、彼氏の答えを彼女が当てる遊び方もできます。',
      },
      {
        q: '無料で遊べますか？',
      ...
      {
        q: 'どんな場面で遊びやすいですか？',
        a: 'デート中、飲み会、旅行、おうち時間など、短時間で相手の好みや考え方を知りたい場面に向いています。',
      },
    ],
    cta: '愛情判定をはじめる',
    related: [
