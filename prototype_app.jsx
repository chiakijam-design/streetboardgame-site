...
// ─────────────────────────────────────────────────────
const RESULT_TIERS = [
  { score: 0, title: '彼氏、彼女検定0級', emoji: '💔', tag: '逆に奇跡', tagBg: proto.black,
    msg: '0問正解はもはや事件。\nでも大丈夫、今日の答え合わせが本編。\nまずは「好き」の取扱説明書から渡そ ♡',
    shareHook: '彼氏、彼女検定0級でした' },
  { score: 1, title: '彼氏、勘で生きてる説', emoji: '🌱', tag: 'ほぼ勘', tagBg: '#F4A261',
    msg: '当てた1問、実力か奇跡か審議中。\nでもここから覚えてくれたら勝ち。\n次のデートは復習回で決定 ✦',
    shareHook: 'うちの彼氏、ほぼ勘で生きてた' },
  { score: 2, title: '彼女データ更新中カップル', emoji: '🌷', tag: 'UPDATE中', tagBg: proto.cyan,
    msg: 'まだ知らない一面、多め。\nでもそれって、これから盛り上がる余白。\n今日の結果を見ながらアップデートしよ ♡',
    shareHook: '彼女データ、まだ更新途中でした' },
  { score: 3, title: 'あと一歩でドヤれるカップル', emoji: '💞', tag: '惜しい', tagBg: '#FF7A92',
    msg: '半分以上わかってるのはちゃんと強い。\nでもドヤ顔するにはあと少し。\n外した問題こそ、次の会話のネタ ♡',
    shareHook: 'あと一歩でドヤれる結果でした' },
  { score: 4, title: 'ほぼ彼女マスター', emoji: '💖', tag: 'GREAT', tagBg: proto.pink,
    msg: 'これはかなり分かってる。\nあと1問で満点なのがいちばん悔しいやつ。\n再挑戦したら伝説、ある ♡',
    shareHook: '彼氏、ほぼ彼女マスターでした' },
