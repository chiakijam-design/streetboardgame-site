...
const GAME_INTRO_CONTENT = {
  ...
  challenge: {
    ...
    faq: [
      ...
      {
        q: '無料で遊べますか？',
        a: '無料で遊べます。クイズ作成、専用URLの共有、10問の答え合わせ、答え合わせレポート、任意の理解度ボードまで利用できます。',
      },
    ],
    cta: '10問クイズを作る',
    ctaHref: '/challenge',
  ...
  live: {
    ...
    faq: [
      ...
      {
        q: '本人の答えはいつ入力しますか？',
        a: '企画作成時には入力しません。配信中に本人用URLから視聴者と同じ問題へ同時に秘密回答し、スタッフが「次の問題へ」を押した時点で両方の回答を締め切ります。',
      },
      {
        q: '視聴者も自分の結果を確認できますか？',
        a: '全問の出題後、一問ずつ行う答え合わせと最終結果で、自分が選んだ回答と正誤を各視聴者の画面に表示します。',
      },
      {
        q: '視聴者に投票人数を表示できますか？',
  ...
  return (
    <div style={{ minHeight: '100vh', background: proto.pink, paddingBottom: 40 }}>
      ...
      <div style={{ padding: '24px 22px' }}>
        <IntroSeoCard
          title="ボドゲ仲間の絆チェック"
          text="ボドゲ仲間の絆判定は、本人が選んだ答えをボドゲ仲間が予想して、どれだけ分かっているかをチェックするゲームです。5問中何問正解したかで、ボドゲ仲間のことをどれだけ理解しているか診断します。"
          details={[
            'スマホを順番に渡すだけなので、ボドゲ会のインストに最適です。',
          ]}
