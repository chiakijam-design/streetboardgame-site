...
function TopScreen({ onStart, onFriend, onFamily, onLovePage, onFriendPage, onFamilyPage, onAbout, onProduct }) {
  return (
    <main aria-labelledby="site-title" style={{
      ...
      <p style={srOnlyStyle()}>
        彼氏が彼女の答えをどれだけ当てられるかを判定する無料カップル診断ゲームです。大学生カップルのデート、飲み会、旅行、おうち時間にもスマホ1台で遊べます。彼氏の愛情判定をメインに、同じゲーム内で遊べる彼女版、友達の友情判定、家族の絆判定も公開中です。
      </p>
...
const GAME_INTRO_CONTENT = {
  love: {
    ...
    lead: '私のこと、ちゃんと分かってるよねは、彼氏の彼女理解度を測定するゲームです。お題が５問出ます。彼女は思った答えをそのまま回答してください。彼氏は彼女が何と答えたか、予想して当ててください。',
  ...
  friend: {
    ...
    lead: '友達の友情判定は、本人が選んだ答えを友達が予想して、どれだけ分かっているかをチェックするゲームです。本人は思った答えをそのまま回答してください。友達は本人が何と答えたか、予想して当ててください。',
  ...
  family: {
    ...
    lead: '家族の絆判定は、本人が選んだ答えを家族が予想して、家族の理解度を楽しくチェックするゲームです。本人は思った答えをそのまま回答してください。家族は本人が何と答えたか、予想して当ててください。',
