...
const GAME_INTRO_CONTENT = {
  ...
  live: {
    ...
    lead: `${LIVE_SERIES.name}は、撮影スタッフがYouTubeチャンネルまたは動画のURLから問題企画を作って保存し、配信中にYouTuber本人と視聴者が回答するゲームです。`,
    body: '「YouTuberの答えを視聴者が予想する」または「YouTuberが視聴者投票の1位を予想する」のどちらかを選びます。30問の候補から1〜30問を採用し、スタッフ用URLで企画を保存できます。配信中はYouTuberと視聴者が同じ問題へ同時に回答し、全問の出題後に一問ずつ答えを発表します。最後に各視聴者の正解数と全問題の結果を表示します。',
    ...
    faq: [
      ...
      {
        q: '本人の答えはいつ入力しますか？',
        a: '企画作成時には入力しません。配信中に視聴者と同じ問題へ同時に回答し、「次の問題へ」を押した時点で両方の回答を締め切ります。',
      },
      {
        q: '視聴者も自分の結果を確認できますか？',
