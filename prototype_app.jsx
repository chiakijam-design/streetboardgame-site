...
const GAME_INTRO_CONTENT = {
  ...
  live: {
    ...
    body: '「YouTuberの答えを視聴者が予想する」または「YouTuberが視聴者投票の1位を予想する」のどちらかを選びます。30問の候補から1〜30問を採用し、スタッフ用URLで企画を保存できます。配信中は1問ずつ本人が秘密で回答してから視聴者投票を開始し、正解発表後は各視聴者の画面にも自分の回答結果が残ります。',
    ...
    faq: [
      ...
      {
        q: '本人の答えはいつ入力しますか？',
        a: '企画作成時には入力しません。配信中に問題を1問ずつ表示し、本人が回答を確定してから視聴者投票を始めます。',
      },
      {
        q: '視聴者も自分の結果を確認できますか？',
