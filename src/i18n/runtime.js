...
const UI_TEXT = new Map(Object.entries({
  ...
  '気分や相手に合うパックを選んでください。どのパックも通常版・LIVE版の両方で使えます。': 'Choose a pack that fits the moment. Every pack works in both Standard and LIVE modes.',
  '10問パック': '10-question pack',
  '入っている10問を見る': 'See the 10 questions',
  '通常版で作る': 'Create in Standard mode',
  'LIVE版で作る': 'Create in LIVE mode',
  ...
  '通常版と同じお題に加えて、配信でコメントが動きやすい4パックを用意しました。': 'Alongside the shared questions, these four packs are designed to get livestream chat moving.',
  'LIVE専用': 'LIVE only',
  'このパックでLIVEを作る': 'Create a LIVE quiz with this pack',
  '通常版と共通の7パックを見る': 'See the 7 shared packs',
  ...
  '今度は役割交代': 'Now swap roles',
  '同じ10問を使って、次はあなたが出題者になれます。元の出題者の正解は引き継がれません。': 'Use the same 10 questions and become the next creator. The previous creator’s answers are never carried over.',
  '役割交代して、次は自分が出題する': 'Swap roles and become the creator',
  '別の10問で自分も作る': 'Create my own quiz with different questions',
  '結果をシェア': 'Share result',
  '画像を保存': 'Save image',
  ...
  '答え合わせから、ひとことを選ぶ（任意）': 'Choose one answer-review comment (optional)',
  '実際の正解・不正解から作った候補を1つ選ぶと、理解度ボードへ結果と一緒に載せられます。': 'Choose one suggestion based on your actual matches and misses to post with your result on the Understanding Board.',
  'コメントなしで載せる': 'Post without a comment',
  '自分で短いコメントを書く': 'Write your own short comment',
  '自分で書くコメント（80文字まで）': 'Your comment (up to 80 characters)',
  ...
  '選んだコメントを確認できませんでした。もう一度選んでください。': 'That comment could not be verified. Please choose it again.',
  'コメントは80文字以内で入力してください。': 'Keep your comment to 80 characters or fewer.',
  'コメントに個人情報らしい内容が含まれています。本名・学校名・SNS ID・電話番号・住所は書かないでください。': 'Your comment may contain personal information. Do not include a full name, school, social media ID, phone number, or address.',
  'このコメントは公開できない表現を含む可能性があります。内容を直してください。': 'This comment may contain language that cannot be published. Please revise it.',
