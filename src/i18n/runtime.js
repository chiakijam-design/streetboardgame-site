...
const UI_TEXT = new Map(Object.entries({
  ...
  '理解度ボードに載せる（共有・保存と同時）': 'Add to Understanding Board when sharing or saving',
  '初期設定はオンです。チェックを外すと、理解度ボードへ載せずに共有・保存します。': 'This is on by default. Uncheck it to share or save without adding the result to the Understanding Board.',
