...
const UI_TEXT = new Map(Object.entries({
  ...
  '回答後は、初期設定では理解度ボードに載ります。結果画面のチェックを外せば非掲載にでき、同じ10問へもう一度挑戦することもできます。': 'After answering, your result is added to the Understanding Board by default. Uncheck it on the result screen to keep it private, or try the same 10 questions again.',
  ...
  '初期設定はオンです。チェックを外すと、理解度ボードから外れます。': 'This is on by default. Uncheck it to remove your result from the Understanding Board.',
