...
const UI_TEXT = new Map(Object.entries({
  ...
  '受付中': 'Open',
  '停止中': 'Paused',
  '最初のメッセージを送ってみよう。': 'Send the first message.',
  'チャットを入力（120文字まで）': 'Write a message (up to 120 characters)',
  '送信': 'Send',
  '配信者がチャットを一時停止しています。': 'The streamer has paused chat.',
  '個人情報・いじめ・性的内容・差別表現は投稿できません。通報された投稿はすぐ非公開になります。': 'Do not post personal information, bullying, sexual content, or discrimination. Reported messages are hidden immediately.',
  '非表示': 'Hide',
  '応援メッセージを送る': 'Send a support message',
  '180円から': 'From ¥180',
  '公開する応援メッセージ（任意・120文字まで）': 'Public support message (optional, up to 120 characters)',
  '例：配信楽しかった！': 'Example: Great stream!',
  '決済完了後にチャットへ表示され、売上の70%が配信者へ分配されます。': 'It appears in chat after payment, and 70% of the sale is allocated to the streamer.',
  ...
  'お問い合わせ': 'Contact',
  '感想・改善要望・お問い合わせ': 'Feedback, ideas & contact',
  '使ってみた感想や改善してほしいこと、不具合・ご質問を送れます。短い一言だけでも歓迎です。': 'Share feedback, improvement ideas, bugs, or questions. Even a short note helps.',
  'こんな声を聞かせてください': 'Tell us what you think',
  'どんなふうに遊んで、何が楽しかったか': 'How you played and what you enjoyed',
  '困ったこと・分かりにくかったこと': 'Anything confusing or difficult',
  'こうなったらもっと使いたい、というアイデア': 'Ideas that would make you want to use it more',
  '送りたい内容': 'What would you like to send?',
  '感想を送りたい': 'Share feedback',
  '改善してほしいことがある': 'Suggest an improvement',
  '困ったこと・不具合を知らせたい': 'Report a problem or bug',
  '使い方・その他を問い合わせたい': 'Ask a question',
  '使った場面': 'Where did you use it?',
  '選ばなくても送れます': 'You can skip this',
  '自分の問題を作った': 'Created my own quiz',
  '届いた問題に回答した': 'Answered a quiz I received',
  '結果・答え合わせ・共有を見た': 'Viewed results, answer check, or sharing',
  'LIVE版を使った': 'Used LIVE mode',
  'まだ使っていない': 'Have not used it yet',
  'その他': 'Other',
  'お名前': 'Name',
  'メールアドレス': 'Email address',
  '感想・改善してほしいこと': 'Feedback or improvement idea',
  '（任意）': '(optional)',
  '（返信が必要な場合のみ）': '(only if you need a reply)',
  '例：楽しかったところ、困ったところ、こうなったらもっと使いたい、など。短い一言だけでも大歓迎です。': 'Example: What you enjoyed, what was confusing, or what would make it better. A short note is welcome.',
  '送信内容はサービス改善・不具合調査・お問い合わせ対応に利用します。個別の返信が必要な場合はメールアドレスをご入力ください。詳しくは': 'We use your message to improve the service, investigate bugs, and respond to inquiries. Enter your email only if you need a reply. See our',
  'をご確認ください。': 'for details.',
  '送信しました。声を届けていただきありがとうございます。': 'Sent. Thank you for sharing your feedback.',
  '通報': 'Report',
