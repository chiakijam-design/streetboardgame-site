...
const UI_TEXT = new Map(Object.entries({
  ...
  '友達・家族・共通のお題から出題します。回答途中はこの端末へ自動保存されます。': 'Questions come from the friends, family, and general libraries. Your progress is saved on this device.',
  '途中保存あり': 'Draft saved',
  '途中から再開': 'Resume',
  '削除': 'Delete',
  '読み込み中です…': 'Loading…',
  ...
  '友達・家族・共通のお題から10問を選び、問題文と5択を自由に編集できます。': 'Choose 10 questions from the friends, family, and general libraries, then edit the question text and five choices.',
