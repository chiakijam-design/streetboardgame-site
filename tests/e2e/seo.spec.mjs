...
test('内部リンクを実URLで辿れ、主要ランドマークが存在する', async ({ page }, testInfo) => {
  ...
  for (const path of ['/remote', '/live', '/live-guide', '/love', '/friends', '/family', '/about', '/product', '/terms', '/privacy', '/legal', '/creator-terms', '/refund-policy', '/content-guidelines', '/minor-policy']) {
